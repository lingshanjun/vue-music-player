...
export default {
  ...
  methods: {
    ...
    progressTouchMove (e) {
      ...
      const offset1 = this.$refs.progressBar.clientWidth - progressBtnWidth;
      const offset2 = Math.max(0, this.touch.left + deltaX);
      const offsetWidth = Math.min(offset1, offset2);
      this._offset(offsetWidth);
    },
    progressTouchEnd (e) {
